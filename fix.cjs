...
// Player.jsx LIMPO
const playerCode = `import { useEffect, useState, useRef } from 'react'
...
// Escreve os arquivos
fs.writeFileSync(path.join(__dirname, 'src', 'pages', 'Player.jsx'), playerCode)
fs.writeFileSync(path.join(__dirname, 'src', 'components', 'SetlistCard.jsx'), setlistCode)

console.log('✅ Player.jsx criado com sucesso!')
console.log('✅ SetlistCard.jsx criado com sucesso!')
console.log('')
