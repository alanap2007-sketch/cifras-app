...
# 1. CORRIGE main.jsx - Remove imports do Capacitor
...
with open('src/main.jsx', 'w', encoding='utf-8') as f:
    f.write(main_code)
print('✅ main.jsx corrigido (sem Capacitor)')

# 2. CORRIGE Player.jsx - Versão 100% limpa
...
with open('src/pages/Home.jsx', 'w', encoding='utf-8') as f:
    f.write(home_code)
print('✅ Home.jsx corrigido')

print('\n🔨 Agora execute:')
print('   npm run build')
print('   git add .')
print('   git commit -m "Corrige build - remove capacitor"')
